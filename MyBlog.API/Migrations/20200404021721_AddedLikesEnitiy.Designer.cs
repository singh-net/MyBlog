...
namespace MyBlog.API.Migrations
{
    ...
    [Migration("20200404021721_AddedLikesEnitiy")]
    partial class AddedLikesEnitiy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBlog.API.Models.Like", b =>
                {
            ...
            modelBuilder.Entity("MyBlog.API.Models.Like", b =>
                {
                    b.HasOne("MyBlog.API.Models.User", "Likee")
                        .WithMany("Likers")
                        .HasForeignKey("LikeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyBlog.API.Models.User", "Liker")
                        .WithMany("Likees")
